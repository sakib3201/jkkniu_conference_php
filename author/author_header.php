...
<body>
  ...
  <nav class="side-navbar">
    ...
    <ul class="list-unstyled">
      <li class="sidebar-item active"><a class="sidebar-link fs-5" href="new_paper_submission.php"> <i class="fa-solid fa-file-circle-plus m-1"></i> Submit Paper</a></li>
      <li class="sidebar-item"><a class="sidebar-link fs-5" href="new_papers.php"> <i class="fa-solid fa-signal m-1"></i></i> New Papers </a></li>
    </ul>
  </nav>
  <div class="page">
    <!-- navbar-->
          ...
          <div class="d-flex align-items-center justify-content-between w-100">
            <div class="d-flex align-items-center">
              ...
              <a class="navbar-brand ms-2">
                <div class="brand-text d-none d-md-inline-block text-capitalize letter-spacing-0 text-white fs-5"> Welcome <span class="fw-bolder fs-4"><?php echo $_SESSION['author_name'] ?></span> </div>
              </a>
            </div>
            <ul class="nav-menu mb-0 list-unstyled d-flex flex-md-row align-items-md-center">
              <!-- Log out-->
              <li class="nav-item"><a class="btn btn-danger p-1 a_hover" href="author_logout.php"> <span class="d-none d-sm-inline-block me-2">Logout</span><i class="fa-solid fa-right-from-bracket"></i></a></li>
            </ul>
          </div>
        </div>
      </nav>
