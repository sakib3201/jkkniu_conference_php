<nav class="navbar navbar-expand-lg secondary_bg">
    <div class="container">
        <a class="navbar-brand" href="index.php"><img src="Images/jkkniu_logo.svg" alt="JKKNIU logo" style="width: 55px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#AboutEvent">About</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#CallForPaper">Call For Paper</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#EventVenue">Event Venue</a>
                </li>
                <li class="nav-item">
        ...
        <div class="nav-item">
            <a class="navbar-brand nav-logo" href="index.php"><img src="Images/ICTBJ Logo.jpg" alt="ICTBJ logo" style="width: 50px;border-radius:50%;"></a>
        </div>
    </div>
</nav>