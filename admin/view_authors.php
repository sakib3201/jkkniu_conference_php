...
<div class="container-fluid mt-5">
    <h3 class="text-center text-secondary fw-bold">All Authors</h3>
    <div class="col">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="delete_author.php?id=<?php echo $author_id ?>" class="btn btn-primary" onclick="return confirmSubmission()">Delete</a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
