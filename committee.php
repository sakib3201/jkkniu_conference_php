...
<div class="container-fluid mt-3" data-aos="fade-up-right" style="min-height: 100vh;">
    ...
    ?>
        <h4 class="fw-bold text-center" data-aos="fade-up">Local Advisory Committee</h4>
            ...
            ?>
                    <div class="col-md-3">
                        <div class="card committee_hover">
                            <img src="Images/committee_images/<?php echo $committee_image ?>" class="card-img-top" alt="committee_image" style="height:30vh">
                            <div class="card-body">
    ...
    if (mysqli_num_rows($run_select_from_new_paper) > 0) {
    ?>
        <h4 class="mt-3 fw-bold text-center" data-aos="fade-up">International Advisory Committee</h4>
        <div class="row row-cols-1 row-cols-md-4 g-4 d-flex justify-content-center">
            <?php
            while ($row = mysqli_fetch_assoc($run_select_from_new_paper)) {
                extract($row);
